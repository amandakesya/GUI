...
import java.awt.*;
    ...
    tomboll.setBounds (50,90,50,25); 
    tombol2.setBounds (110,90,50,25); tombol Tambah.setBounds (180, 90, 50, 25); 
    tombolSamaDengan.setBounds (240, 90, 50,25);

    /* Menambahkan Action Listener pada button */ 
    tomboll.addActionListener(new TombolHandler()); 
    ...
    setelahOperator = false;
            ...
            try {
            operant Pertama Double.parseDouble (operantl); 
            } catch (Exception ex) { 
            }
